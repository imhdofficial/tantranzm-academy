...
<html lang="en">
  ...
  <main>
            ...
            <div class="px-4 px-sm-4 py-5">
              ...
              <div style="overflow: hidden;">
                <h1 class="text-white AmsiProU text-uppercase display-6" >
                    ...
                    data-aos-duration="700"
                    data-aos-easing="ease-in-out"
                    data-aos-anchor-placement="top">Placements</span>
              ...
              <p class="text-white GraphikM" data-aos="fade-up"
              data-aos-delay="300"
              data-aos-duration="700"
              data-aos-easing="ease-in-out"
              data-aos-anchor-placement="top">
                Tantrazm technology is committed to making it easier for people to learn, explore and evolve their careers through expert training.
              </p>
              ...
              data-aos-duration="700"
              data-aos-easing="ease-in-out"
              data-aos-anchor-placement="top">Explore Programs <img class="ps-3" src="img/aero.png" alt=""></button>
          ...
          <div class="owl-carousel owl-theme ps-sm-5 ms-sm-4">
            <div class="item" data-aos="fade-right" data-aos-delay="500" data-aos-duration="700" data-aos-easing="ease-in-out" data-aos-anchor-placement="top">
              <div class="bg-white p-5 ">
                ...
                <p class="GraphikM mt-3">Ben Goldberg</p>
                <p class="GraphikM text-black-50 mt-3">Developer Advocate at DataStax</p>
                <p class="GraphikR text-black-50 mt-3">Amanda is a developer advocate for DataStax after spending the last 6 years as a software engineer on 4 different distributed databases. Her passion is bridging the gap between customers and engineering. She has degrees from the University of Washington and Santa Clara University.</p>
              </div>
            </div>
            <div class="item" data-aos="fade-right" data-aos-delay="600" data-aos-duration="700" data-aos-easing="ease-in-out" data-aos-anchor-placement="top">
              <div class="bg-white p-5 ">
                <img style="width: 101px;" src="img/lwb-icons.png" alt="">
                <p class="GraphikM mt-3">Ben Goldberg</p>
                <p class="GraphikM text-black-50 mt-3">Developer Advocate at DataStax</p>
            ...
            <div class="item" data-aos="fade-right" data-aos-delay="700" data-aos-duration="700" data-aos-easing="ease-in-out" data-aos-anchor-placement="top">
              <div class="bg-white p-5 ">
                <img style="width: 101px;" src="img/lwb-icons.png" alt="">
                <p class="GraphikM mt-3">Ben Goldberg</p>
                <p class="GraphikM text-black-50 mt-3">Developer Advocate at DataStax</p>
            ...
            <div class="item" data-aos="fade-right" data-aos-delay="800" data-aos-duration="700" data-aos-easing="ease-in-out" data-aos-anchor-placement="top">
              <div class="bg-white p-5 ">
                <img style="width: 101px;" src="img/lwb-icons.png" alt="">
                <p class="GraphikM mt-3">Ben Goldberg</p>
                <p class="GraphikM text-black-50 mt-3">Developer Advocate at DataStax</p>
            ...
            <div class="item" data-aos="fade-right" data-aos-delay="900" data-aos-duration="700" data-aos-easing="ease-in-out" data-aos-anchor-placement="top">
              <div class="bg-white p-5 ">
                <img style="width: 101px;" src="img/lwb-icons.png" alt="">
                <p class="GraphikM mt-3">Ben Goldberg</p>
                <p class="GraphikM text-black-50 mt-3">Developer Advocate at DataStax</p>
    ...
    <!-- ---------------------Learn with the best End--------------------- -->


    <!-- <div class="mt-4 pt-4"></div> -->

    <!-- Get Hired by Industry Leading Companies Start -->
    ...
    <!-- Get Hired by Industry Leading Companies End -->
    ...
    <!-- Helping people Transform The World End  -->
          ...
          <div class="col-sm-7 col-12 position-relative">
            <div class="alphaList">
              <ul>
                ...
                <div class="border-bottom">
                  <li class="" data-aos="fade-up" data-aos-delay="2500" data-aos-duration="700" data-aos-easing="ease-in-out" data-aos-anchor-placement="top">High-tech labs to ensure unmatched learning.</li>
                </div>  
              </ul>
            </div>
