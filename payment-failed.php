        ...
        <div class="row">
          <div class="col-lg-7 bg-white position-relative">
            ...
            <div class="px-5">
              <div class="pt-5"></div>
              <div class="pt-5"></div>
              <p class="text-danger fs-3 GraphikSB">Payment Failed</p>
              <p class="GraphikM pe-5 me-5 text-black-50">Your payment was failed due to incorrect PIN</p>
              ...
              <div class="pt-4"></div>
              <button class="border-0 GraphikM rounded-0 text-white btn-danger btn py-3 px-4">Retry Payment</button>
              <div class="pt-5"></div>
              <div class="pt-5"></div>
              <div class="pt-5"></div>
              <div class="pt-5"></div>
