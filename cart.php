          ...
          <div class="row">
                ...
                <div class="col-10">
                  <div class="ps-2 pe-4">
                    <div class="d-flex justify-content-between">
                      ...
                      <p class="GraphikSB fs-5 mb-1">₹22849</p>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                      ...
                      <img src="img/cart/bin.svg" alt="" class="img-fluid">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-4">
              <div class="ps-4">
                ...
                <p class="GraphikSB text-muted">(3 items)</p>
                <button style="background-color: #58C1A3;" class="border-0 rounded-1 text-white btn w-100 py-3">Buy Now</button>
              </div>
            </div>
          </div>
        </div>
